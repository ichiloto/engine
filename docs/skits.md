...
```php
'beats' => [
  ['speaker' => 'Liora', 'emotion' => 'Concerned', 'voice' => 'liora-01',
   'text' => "You keep hiding how bad it was on the road.\nYou don't have to carry it all alone, Kaelion."],
  ['speaker' => 'Kaelion', 'emotion' => 'Determined', 'voice' => 'kaelion-01',
   'text' => '…'],
],
```
...
2. Implement the skit stage as a canvas presentation (title, location,
   nameplate, panel, static busts, active-speaker emphasis), themed by the
...
- Lip sync is loop-while-the-line-plays; no audio decoding in the engine.
